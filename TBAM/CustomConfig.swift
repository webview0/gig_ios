...
class ConfigTBAM : CustomConfigProtocol
{
    ...
    func getHomeMenu() -> [HomeMenuItem]
    {
        ...
        menu.append(HomeMenuItem(title: "Calendar",     icon: "mainmenu_calendar400x400c",    url: "http://www.tbam.org/index.php?src=events&srctype=events_lister_app"))
        menu.append(HomeMenuItem(title: "Contact",      icon: "mainmenu_contact400x400c",     url: "submenu://contact"))
        menu.append(HomeMenuItem(title: "Directory",    icon: "mainmenu_directory400x400c",   url: "http://www.tbam.org/index.php?src=membership&srctype=membership_lister_app"))
        ...
        menu.append(HomeMenuItem(title: "Prayer",       icon: "mainmenu_prayer400x400c",      url: "http://www.tbam.org/index.php?src=gendocs&ref=prayer"))
        menu.append(HomeMenuItem(title: "Torah Study",  icon: "mainmenu_torahstudy400x400c",  url: "http://asoft4124.accrisoft.com/betham/index.php?src=gendocs&ref=TorahStudyBroadcast_App"))
        menu.append(HomeMenuItem(title: "Divrei Torah", icon: "mainmenu_divreitorah400x400c", url: "http://asoft4124.accrisoft.com/betham/index.php?src=gendocs&ref=WeeklyMeditations_App"))
        menu.append(HomeMenuItem(title: "Services",     icon: "mainmenu_services400x400c",    url: "http://www.tbam.org/index.php?src=events&srctype=events_lister_app&category=Shabbat+and+Services"))
        
        menu.append(HomeMenuItem(title: "Schools",      icon: "mainmenu_schools400x400c",     url: "http://www.tbam.org/index.php?src=gendocs&ref=school_landing_page"))
        menu.append(HomeMenuItem(title: "Do a Mitzvah", icon: "mainmenu_doamitzvah400x400c",  url: "http://www.tbam.org/index.php?src=forms&ref=Do_a_Mitzvah"))
        menu.append(HomeMenuItem(title: "Donate",       icon: "mainmenu_donate400x400c",      url: "https://asoft4124.accrisoft.com/betham/index.php?src=forms&ref=Online_Donation_From_App"))
        menu.append(HomeMenuItem(title: "Memberhood",   icon: "mainmenu_memberhood400x400c",  url: "http://asoft4124.accrisoft.com/betham/index.php?src=gendocs&ref=Memberhood_App"))
